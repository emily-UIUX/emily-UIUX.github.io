...
export function generateSecuritiesItems(count: number): NaverSecuritiesItem[] {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const openingPrice = article.openingPrice
    ...
    const stockUrl = article.stockTicker
      ? `https://finance.naver.com/item/main.naver?code=${article.stockTicker}`
    ...
    items.push({
      ...
      relatedStocks: [
        { ticker: '005930', name: '삼성전자', openingPrice: 71200, currentPrice: generateCurrentPrice(71200) },
        { ticker: '000660', name: 'SK하이닉스', openingPrice: 178000, currentPrice: generateCurrentPrice(178000) },
      ],
    })
  }
